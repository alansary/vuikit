<template>
  <div>
    ...
    <div class="uk-container">
      ...
      <vk-modal size="container" :show.sync="container">
        <vk-modal-close @click="container = false"></vk-modal-close>
        <p v-for="n in 10">{{ lorem }}</p>
      </vk-modal>

      <vk-modal size="3-4@m 2-3@l 1-2@xl" :show.sync="width">
        <vk-modal-close @click="width = false"></vk-modal-close>
        <p v-for="n in 10">{{ lorem }}</p>
      </vk-modal>

      <vk-modal center :show.sync="center">
        <vk-modal-close @click="center = false"></vk-modal-close>
        <p>{{ lorem }}</p>
      </vk-modal>

      <vk-modal-full :show.sync="full">
      ...
      <vk-modal-full :show.sync="fullSplit">
      ...
      <vk-modal stacked :show.sync="stack2">
